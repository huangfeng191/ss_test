var config = {
    ...
    baseDir: 'E:/c_project/Server/src/main/webapp/',
    ...
    developProxyUry: "http://192.168.1.242:8080"
...
gulp.task('browser-sync-static', function() {
    ...
    bs.watch([
        ...
        // "/**/src/page/*.html",
        // "/**/*.html"  //减少监视
        // E:\c_project\Server\src\main\webapp\controller\ssuconfig\ssuIrrationalCtrl.js
        // "",
        // "/index.html"  ,//减少监视
        "/controller/ssuconfig/ssuIrrationalCtrl.js"  //减少监视
    // ], { ignored: /(^|[\/\\])\../ }).on("change", bs.reload);
    ], { ignored: /(^|[\/\\])\../ }).on("change", function(){
